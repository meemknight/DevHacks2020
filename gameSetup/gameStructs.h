...
#pragma region textures
	...
	gl2d::Texture diamond;
	gl2d::Texture club;
	gl2d::Texture spade;
	gl2d::Texture heart;
	gl2d::Texture clock;
	gl2d::Texture coin;
	gl2d::Texture diamondYellow;
	gl2d::Texture dolar;
	gl2d::Texture clover;
	gl2d::Texture star;

	gl2d::Texture cards;
	gl2d::Texture backCard;
	gl2d::Texture goldBack;
	gl2d::TextureAtlas cardsAtlas;

	gl2d::Texture playerTexture;
	gl2d::TextureAtlas playerAtlas;

	gl2d::Texture wallTexture;
	gl2d::TextureAtlas wallAtlas;

	gl2d::Texture shatter[4];

	gl2d::Texture rulette;

#pragma endregion

#pragma region particles

	gl2d::ParticleSettings basicParticle[9];
	gl2d::ParticleSettings shatterPart[4];
	gl2d::ParticleSettings coinEmiter;
	gl2d::ParticleSettings manyCoins;
	gl2d::ParticleSettings downCoin;

	gl2d::ParticleSettings coinRain;
...
#pragma endregion
	...
	std::vector<FallingCard> fallingCards;
	std::vector<Card> cardHand;
	std::vector<Card> rightHand;
	std::vector<Card> fadeRightHand;
	std::vector<Card> fadeCardHand;
	float fadeCardTime;
	float fadeRightCardTime;

	std::mt19937 random{ std::random_device{}() };
	float timeTilllastFall = 0;
	float gameTime;
	...
	int currentSuite = 0;
	float fadeSuiteTime = 0;

	//sf::Music musicPlayer;

	float flushTextTime = 0;
	bool flushTextState = 0;

	float showMinusTimeTime = 0;
	float goldRushTime = 0;
